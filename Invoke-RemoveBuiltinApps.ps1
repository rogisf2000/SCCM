<#
.SYNOPSIS
    Remove Builtin Apps from Windows 10
.DESCRIPTION
.EXAMPLE
    .\Invoke-BuiltinApps.ps1
.NOTES
Available at https://github.com/SCConfigMgr/ConfigMgr/blob/master/Operating%20System%20Deployment/Invoke-RemoveBuiltinApps.ps1
.NOTES
